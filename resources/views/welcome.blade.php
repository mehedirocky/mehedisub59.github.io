...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand" href="index.html">From learnHunter</a>
  ...
  <!-- Page Header -->
  <header class="masthead" style="background-image: url('public/fontend/img/home-bg.jpg')">
      ...
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          <div class="site-heading">
            <h1>Laravel Blog</h1>
            <span class="subheading">Md. Mehedi Hasan</span>
          </div>
        </div>
      </div>
    </div>
